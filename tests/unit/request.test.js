...
const { mockCreate, mockFindOne, mockCreateMany } = mockedCalls;
...
describe('Request Service', () => {
  ...
  it('should reject non-requester role', async () => {
    ...
    await expect(submitRequestService(CREATE_REQUEST_PAYLOAD)).rejects.toThrow(
      'User is not in a requester role.'
    );
